      ...
      <div className={styles.map}>
        ...
        >
          ...
          <g className={styles.regions}>
            <polygon
              id="Hrodna"
              className={currentRegion === "Hrodna" ? styles.active : ""}
              onClick={handleClick}
            ...
            <polygon
              id="Homel"
              className={currentRegion === "Homel" ? styles.active : ""}
              onClick={handleClick}
      ...
      <div className={styles.links}>
        <ul className={styles.linkWrapper}>
          {region.exhibition.map((item) => (
            <NavLink to="/exhibitions" key={item.id}>
              <li>
          ...
          {/* <li>
            <a href="#">District near Minsk. Shirt #</a>
          </li>
          <li>
            <a href="#">District near Minsk. Shirt #</a>
          </li>
